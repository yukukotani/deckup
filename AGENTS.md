...
- When changing navigation, update `packages/core/runtime/scripts/navigation.ts` plus `apps/cli/tests/navigation.test.ts`, then verify the `example/` deck if behavior is visual.
